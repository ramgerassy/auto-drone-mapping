...
| 3 | `feat/frontier-strategy` | `planning`: `FrontierStrategy` protocol + `NearestFrontier` (+ spatial spreading penalty) | mapping (1), 2 | 🔄 planned — [plan](sprint-2/feature-3-frontier-strategy.md) |
